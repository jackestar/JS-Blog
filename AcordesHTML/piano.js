...
// formstring = formstring + '\r' + ' ';
dispstring = formstring.substring(0, (formstring.length - 2));
...
if (note == 3){
formstring = formstring + 'Re, '
playkey(2)
}
if (note == 4){
formstring = formstring + 'Mib, '
playsharp(2)
}
if (note == 5){
formstring = formstring + 'Mi, '
playkey(3)
}
if (note == 6){
formstring = formstring + 'Fa, '
playkey(4)
}
if (note == 7){
...
if (vr2.charAt(ndums +1) != ","){
chartf = vr2.substring(ndums, (vr2.indexOf(",")+ ndums +1))
incr = 2
in2= 1
}
else {
chartf = vr2.substring(ndums, (vr2.indexOf(",")+ ndums))
incr = 1
in2= 0
}
tochange = parseFloat(chartf)
vr1 = vr2.substring(0, ndums) + (tochange - 12) + vr2.substring((ndums + incr), vr2.length)
}
dispch(vr1);
ips ++
}