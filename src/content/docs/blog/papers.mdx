...
#### Practica de Laboratorio #1 - Diodos<Badge variant="note" text="Electronica I" />
...
#### Practica de Laboratorio #2 – Integrado 555<Badge variant="note" text="Electronica I" />
...
<Badge variant="tip" text="astable" /><Badge variant="tip" text="monostable" /><Badge variant="tip" text="555" />

[link](https://drive.google.com/file/d/1DGh52xdump_2K6owW0B6AVQ0c6uhBlWF/view)
</div>
<div class="JSDocument">

#### Practica de Laboratorio #3 – Osciloscopio<Badge variant="note" text="Electronica I" />
...
<Badge variant="tip" text="Osciloscopio" />
...
#### Practica de Laboratorio #4 – Voltaje de Rizo<Badge variant="note" text="Electronica I" />
...
<Badge variant="tip" text="Voltaje Rizo" />

[link](https://drive.google.com/file/d/1fFwOWtftRTiVVk_RPD-Qi44edEFqXgTS/view)
</div>
<div class="JSDocument">

#### Practica de Laboratorio #5 – Transistor y Relé<Badge variant="note" text="Electronica I" />
...
<Badge variant="tip" text="Transistor" /><Badge variant="tip" text="Relé" /><Badge variant="tip" text="Digital" />

[link](https://drive.google.com/file/d/1yeJT9aQIcB3y-QjKWoXfbNXCjlF1FudO/view)
</div>
<div class="JSDocument">

#### Practica de Laboratorio #6 – Fuente Regulable<Badge variant="note" text="Electronica I" />
...
<Badge variant="tip" text="Transistor" />
...
#### Practica de Laboratorio #1 – Amplificador de Doble Etapa<Badge variant="note" text="Electronica II" />
...
<Badge variant="tip" text="Amplificador" /><Badge variant="tip" text="Ganancia" /><Badge variant="tip" text="Impedancia" />
...
#### Practica de Laboratorio #2 – Amplificador Operacional<Badge variant="note" text="Electronica II" />
...
<Badge variant="tip" text="Amplificador" /><Badge variant="tip" text="Ganancia" /><Badge variant="tip" text="Operacional" />
...
#### Practica de Laboratorio #3 – Generador de Onda Triangular<Badge variant="note" text="Electronica II" />
...
<Badge variant="tip" text="Amplificador Operacional" /><Badge variant="tip" text="Generador de Diente de Sierra" />
...
#### Diseño e implementación de un rectificador activo autoalimentado con MOSFETs para aplicaciones de alta corriente en DC<Badge variant="note" text="Electronica II" />
...
<Badge variant="tip" text="rectificación activa" /><Badge variant="tip" text="MOSFET" /><Badge variant="tip" text="modulación por ancho de pulso (PWM)" /><Badge variant="tip" text="eficiencia energética" /><Badge variant="tip" text="puente rectificador" />
...
#### Practica de Laboratorio #1 – Rectificador de Precisión<Badge variant="note" text="Electronica III" />
...
<Badge variant="tip" text="amplificador operacional" /><Badge variant="tip" text="rectificador de precisión" /><Badge variant="tip" text="pequeña señal" />
...
#### Practica de Laboratorio #2 – Desfasador<Badge variant="note" text="Electronica III" />
...
<Badge variant="tip" text="amplificador operacional" /><Badge variant="tip" text="desfasador de onda" />
...
#### Practica de Laboratorio #3 – Etapa de Potencia<Badge variant="note" text="Electronica III" />
...
<Badge variant="tip" text="amplificador de potencia" /><Badge variant="tip" text="clase B" /><Badge variant="tip" text="clase AB" /><Badge variant="tip" text="distorsión de cruce" /><Badge variant="tip" text="push-pull" />
...
#### Practica de Laboratorio #4 – Respuesta de frecuencia<Badge variant="note" text="Electronica III" />
...
<Badge variant="tip" text="respuesta en frecuencia" /><Badge variant="tip" text="amplificador" />
...
#### Amplificador Integrado<Badge variant="note" text="Electronica III" />
...
<Badge variant="tip" text="amplificador integrado" /><Badge variant="tip" text="amplificador de audio" />
...
#### EVALUACIÓN #1<Badge variant="note" text="Teoría de Control Automático" />
...
#### EVALUACIÓN #2<Badge variant="note" text="Teoría de Control Automático" />
...
#### EVALUACIÓN #3<Badge variant="note" text="Teoría de Control Automático" />
...
#### EVALUACIÓN #4<Badge variant="note" text="Teoría de Control Automático" />
...
#### Implementación de una Estrategias de Control Estación Didáctica de Simulación<Badge variant="note" text="Control de Procesos" />
...
#### Diseño y Caracterización de un Sistema de Generación de Vapor por Caldera Industrial<Badge variant="note" text="Control de Procesos" />
...
### Generador de Viento Iónico por Efecto Biefeld-Brown<Badge variant="note" text="Física III" />
...
<Badge variant="tip" text="Efecto Biefeld-Brown" />
<Badge variant="tip" text="Viento Iónico" />
<Badge variant="tip" text="Capacitor Asimétrico" />
